...
material_list = {
	...
	"StandardSolid" : ["Solid", Colors["white"], 0.065, 0.25, 10],
	"KinematicSolid" : ["Solid", Colors["purple"], 0.065, 0.25, 5],
	"Player": ["Solid", Colors["gray"], 0.065, 0.25, 5],
	"Trampoline" : ["Solid", Colors["red"], 0.065, 0.8, 20],
